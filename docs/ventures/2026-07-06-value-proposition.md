...
Du berättar varför du äger dina aktier. Vi läser allt, varje dag, och säger till när något du bryr dig om ändras.
...
- **Vakter & larm** *(mock, hjärtat)*: du sätter gränserna, vi ritar kurvan mot dem. Vi hör av oss bara när en gräns passeras.
...
- **Löftesliggaren:** ledningens löften ur gamla pressmeddelanden följda mot facit ("två av fyra höll tidplanen").
- **Emissionshistoriken:** alla kapitalanskaffningar med kurs och rabatt.
- **Utspädningsvakten** *(fas 2)*: läser kallelser och prospekt, varnar för bemyndiganden och konvertibelförfall i förväg.
...
**Onboardingen** *(mock)*: "Varför äger du bolaget?" i klartext, tre saker att hålla koll på, gränser du sätter själv. Kurslänkar inbyggda.
...
- **Kursen:** engångsköp (995 till 1 995 kr testas), ingår i årsprenumerationen.
- **Premium ~199 kr/mån:** personliga brevet, bevakningen, rapportanalyserna, fråga & förklara.
- **Pro ~995 kr/mån:** konsensusdata, korsrisk, ansvarsliggaren, Sebastians krets.

## Vallgraven
Sammanfattningar och bevakning blir commodity inom några år. Beteendedatan, skäl, gränser, beslut och avvikelser över tid, blir bara mer värdefull ju längre användaren stannar, och den kan ingen konkurrent replikera. **Bevakningen är inträdesbiljetten. Beteendedatan är vallgraven.**

## Byggs härnäst
Konton och betalning · extraktionsmotorn med noll-hallucinationskrav · gratis registerdata (FI, MFN) · mejlutskicket. Fas 1 är rapportanalysen, 4 till 6 veckor.

---

*Klickbart: `/labs/agar-ai-v2.html` (produkten) · `/labs/agar-ai-resan.html` (90-dagarsdemon) · `/labs/agarkollen-karta.html` (funktionskartan). Allt fiktiv exempeldata.*
